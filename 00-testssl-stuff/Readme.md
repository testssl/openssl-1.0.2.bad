...
2.) Apply the fedora-dirk-ipv6.patch in this directory (00-testssl-stuff)

3.) Now, there are two options to compile this. Recommended is the first one below.

-  A.  Best is use the script make-openssl.sh from his directory. It configures and makes the binary of your choice.

-  B. Alternatively you can also compile everything manually
